      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-green-900">{data.clientInfo?.name}</h3>
            <p className="text-sm text-green-700">DP ID: {data.clientInfo?.dpmClientId}</p>

          </div>
          <div className="text-right">
            <div className="flex gap-2 text-sm">
              <span
                className={`px-2 py-1 rounded-full ${data.clientInfo?.clientStatus === "Active" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
              >
